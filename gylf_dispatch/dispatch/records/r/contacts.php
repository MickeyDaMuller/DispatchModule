<?php
    ...
    $tblDemo = new ajaxCRUD("Contacts", "contacts", "list_Id", "../");
    ...
    //$tblDemo->displayAs("newsletter_name", "Group name");
    //$tblDemo->displayAs("neswletter_description", "Group description");
    ...
    $tblDemo->omitField("crypt_val");
	$tblDemo->omitField("valid");
	$tblDemo->omitField("updated");
	$tblDemo->omitField("timestamp");
	$tblDemo->omitField("crypt_val");
	$tblDemo->omitField("welcome");
	$tblDemo->omitField("personal");
   ...
   //$tblDemo->defineAllowableValues("fldCertainFields", $allowableValues);
	...
	//$tblDemo->formatFieldWithFunction('newsletter_name', 'makeBlue');
